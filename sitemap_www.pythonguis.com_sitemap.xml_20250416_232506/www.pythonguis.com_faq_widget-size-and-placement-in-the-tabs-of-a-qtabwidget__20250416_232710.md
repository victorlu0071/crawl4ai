# Content from: https://www.pythonguis.com/faq/widget-size-and-placement-in-the-tabs-of-a-qtabwidget/

[](https://www.pythonguis.com/faq/widget-size-and-placement-in-the-tabs-of-a-qtabwidget/#menu)
  * Python GUIs
...
![Screenshot 2020-11-03 161135|416x500](https://www.pythonguis.com/static/faq/forum/widget-size-and-placement-in-the-tabs-of-a-qtabwidget/ry7pMh8KN3LmU2Z0QlilY5iF3oe.png)
...
![Screenshot 2020-11-03 161239|416x500](https://www.pythonguis.com/static/faq/forum/widget-size-and-placement-in-the-tabs-of-a-qtabwidget/5WcIyS823GUtJhtvqArXZCQbKnf.png)
python ```
    # Third tab
...
Just replying for the sake of closing this old topic: the solution is to [add stretchable space](https://doc.qt.io/qt-5/qboxlayout.html#addStretch) to the vertical layout. The stretch will push the widgets up in the layout and extend to the bottom of the layout.
...
**Widget size and placement in the tabs of a QTabWidget** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/widget-size-and-placement-in-the-tabs-of-a-qtabwidget/Python books) on the subject. 
**Widget size and placement in the tabs of a QTabWidget** was published in [faq](https://www.pythonguis.com/faq/) on November 04, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
