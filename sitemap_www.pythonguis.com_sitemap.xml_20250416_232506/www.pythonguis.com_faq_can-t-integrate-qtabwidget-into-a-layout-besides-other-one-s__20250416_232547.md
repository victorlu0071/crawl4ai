# Content from: https://www.pythonguis.com/faq/can-t-integrate-qtabwidget-into-a-layout-besides-other-one-s/

[](https://www.pythonguis.com/faq/can-t-integrate-qtabwidget-into-a-layout-besides-other-one-s/#menu)
  * Python GUIs
...
This is the Layout before and after : ![vorher_nachher|690x188](https://www.pythonguis.com/static/faq/forum/can-t-integrate-qtabwidget-into-a-layout-besides-other-one-s/AkB247cG75WGfnQIjbltLk2NlKx.jpeg)
...
I don´t understand why it´s getting dominant as the only one. Isn´t it possible to have a QTabWidget in a Layout besides other Layouts ?
...
**Can´t integrate QTabWidget into a Layout besides other one´s** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/can-t-integrate-qtabwidget-into-a-layout-besides-other-one-s/Python books) on the subject. 
**Can´t integrate QTabWidget into a Layout besides other one´s** was published in [faq](https://www.pythonguis.com/faq/) on October 05, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
