# Content from: https://www.pythonguis.com/faq/problem-when-using-spyder/

[](https://www.pythonguis.com/faq/problem-when-using-spyder/#menu)
  * Python GUIs
...
**Problem when using Spyder** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/problem-when-using-spyder/Python books) on the subject. 
**Problem when using Spyder** was published in [faq](https://www.pythonguis.com/faq/) on January 30, 2021 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
