# Content from: https://www.pythonguis.com/faq/how-to-add-widget-after-loading-qtdesiger-ui-file/

[](https://www.pythonguis.com/faq/how-to-add-widget-after-loading-qtdesiger-ui-file/#menu)
  * Python GUIs
...
But, how can add a button or label, to either the main window and/or my PlotWidget? `self.label = QtWidgets.QLabel()`
...
**How to Add Widget after loading QtDesiger ui file?** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/how-to-add-widget-after-loading-qtdesiger-ui-file/Python books) on the subject. 
**How to Add Widget after loading QtDesiger ui file?** was published in [faq](https://www.pythonguis.com/faq/) on February 06, 2021 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
