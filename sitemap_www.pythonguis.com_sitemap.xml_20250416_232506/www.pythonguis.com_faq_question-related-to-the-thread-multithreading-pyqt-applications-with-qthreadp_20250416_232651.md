# Content from: https://www.pythonguis.com/faq/question-related-to-the-thread-multithreading-pyqt-applications-with-qthreadpool/

[](https://www.pythonguis.com/faq/question-related-to-the-thread-multithreading-pyqt-applications-with-qthreadpool/#menu)
  * Python GUIs
...
This is making use of Python _keyword unpacking_. This allows you to pass keyword parameters to functions using a dictionary of key=value pairs. 
...
**Question related to the thread Multithreading PyQt applications with QThreadPool** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/question-related-to-the-thread-multithreading-pyqt-applications-with-qthreadpool/Python books) on the subject. 
**Question related to the thread Multithreading PyQt applications with QThreadPool** was published in [faq](https://www.pythonguis.com/faq/) on July 16, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
