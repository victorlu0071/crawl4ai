# Content from: https://www.pythonguis.com/faq/decimal-seperator-qtgui-qdoublevalidator/

[](https://www.pythonguis.com/faq/decimal-seperator-qtgui-qdoublevalidator/#menu)
  * Python GUIs
...
RE Using "QDoubleValidator(double _bottom_ , double _top_ , int _decimals_ , [QObject](https://doc.qt.io/qt-5/qobject.html#QObject) * _parent_ = nullptr)"
...
Hi @Alexis_Labuschagne The decimal separator is handled through the _locale_ which defines how numbers are displayed/handled for localization purposes. 
The comma separator is probably following your system defaults, but you can override it as follows. This creates a custom locale (using United States, which uses the decimal point for decimals) and applies it to the field. Note that the comma is still allowed, since this is a decimal _group_ operator. 
...
**Decimal seperator: QtGui.QDoubleValidator** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/decimal-seperator-qtgui-qdoublevalidator/Python books) on the subject. 
**Decimal seperator: QtGui.QDoubleValidator** was published in [faq](https://www.pythonguis.com/faq/) on January 03, 2021 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
