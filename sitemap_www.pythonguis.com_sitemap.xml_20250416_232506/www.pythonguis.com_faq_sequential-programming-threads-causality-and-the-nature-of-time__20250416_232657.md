# Content from: https://www.pythonguis.com/faq/sequential-programming-threads-causality-and-the-nature-of-time/

[](https://www.pythonguis.com/faq/sequential-programming-threads-causality-and-the-nature-of-time/#menu)
  * Python GUIs
...
Martin has written a wonderful article about [threads and thread-blocking in GUI applications](https://www.pythonguis.com/tutorials/multithreading-pyqt-applications-qthreadpool/). You'll find all your answers there.
...
**Sequential programming, threads, causality, and the nature of time** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/sequential-programming-threads-causality-and-the-nature-of-time/Python books) on the subject. 
**Sequential programming, threads, causality, and the nature of time** was published in [faq](https://www.pythonguis.com/faq/) on April 08, 2021 (updated September 02, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
