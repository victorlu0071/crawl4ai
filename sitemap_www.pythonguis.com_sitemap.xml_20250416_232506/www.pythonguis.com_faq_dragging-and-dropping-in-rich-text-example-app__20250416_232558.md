# Content from: https://www.pythonguis.com/faq/dragging-and-dropping-in-rich-text-example-app/

[](https://www.pythonguis.com/faq/dragging-and-dropping-in-rich-text-example-app/#menu)
  * Python GUIs
...
![](https://www.pythonguis.com/static/faq/forum/dragging-and-dropping-in-rich-text-example-app/5eufts8DF9FcjXlcW0C3IAj0TXe.png)
[PyQt/PySide 1:1 Coaching with Martin Fitzpatrick](https://cal.com/mfitzp/60min-python-guis-coaching/) — Get one on one help with your Python GUI projects. Working together with you I'll identify issues and suggest fixes, from bugs and usability to architecture and maintainability. 
[Book Now](https://www.pythonguis.com/live/) [60 mins ($195)](https://cal.com/mfitzp/60min-python-guis-coaching/)
Mark As Complete 
[![Martin Fitzpatrick](https://www.pythonguis.com/static/theme/images/authors/martin-fitzpatrick.jpg)](https://www.pythonguis.com/authors/martin-fitzpatrick/)
**Dragging and dropping in rich text example app** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/dragging-and-dropping-in-rich-text-example-app/Python books) on the subject. 
**Dragging and dropping in rich text example app** was published in [faq](https://www.pythonguis.com/faq/) on May 11, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
