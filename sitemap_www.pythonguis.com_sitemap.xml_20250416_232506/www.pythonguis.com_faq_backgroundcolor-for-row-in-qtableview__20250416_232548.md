# Content from: https://www.pythonguis.com/faq/backgroundcolor-for-row-in-qtableview/

[](https://www.pythonguis.com/faq/backgroundcolor-for-row-in-qtableview/#menu)
  * Python GUIs
...
**BackGroundColor for row in QTableView** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/backgroundcolor-for-row-in-qtableview/Python books) on the subject. 
**BackGroundColor for row in QTableView** was published in [faq](https://www.pythonguis.com/faq/) on March 11, 2021 (updated November 04, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
