# Content from: https://www.pythonguis.com/faq/matplotlib-not-taking-whole-of-the-window/

[](https://www.pythonguis.com/faq/matplotlib-not-taking-whole-of-the-window/#menu)
  * Python GUIs
...
Also available from [Leanpub](https://www.leanpub.com/create-simple-gui-applications/) and [Amazon Paperback](https://www.amazon.com/dp/B08RB2HRS1/)
  * Use "promote" to place a matplotlib widget (based on a QWidget) in Qt Designer [this tutorial](https://www.pythonguis.com/courses/qt-creator/embed-pyqtgraph-custom-widgets-qt-app/) for embedding PyQtGraph will explain how (the process isn't PyQtGraph specific)
  * Build your layout _except for the plot_ in Qt Designer and then place just that from your code
...
**Matplotlib not taking whole of the window** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/matplotlib-not-taking-whole-of-the-window/Python books) on the subject. 
**Matplotlib not taking whole of the window** was published in [faq](https://www.pythonguis.com/faq/) on May 07, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
