# Content from: https://www.pythonguis.com/faq/transparent-textbrowser/

[](https://www.pythonguis.com/faq/transparent-textbrowser/#menu)
  * Python GUIs
...
If you're using `QTextEdit` you can use `.setTextColor` to set the color of the text, although for the effect you're after you'd have to reset the _previous_ line back to the normal color too.
...
**Transparent TextBrowser** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/transparent-textbrowser/Python books) on the subject. 
**Transparent TextBrowser** was published in [faq](https://www.pythonguis.com/faq/) on February 12, 2021 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
  * [](https://www.pythonguis.com/ "Python GUIs")
