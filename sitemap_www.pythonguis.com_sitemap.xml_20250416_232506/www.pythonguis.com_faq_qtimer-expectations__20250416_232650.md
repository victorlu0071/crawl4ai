# Content from: https://www.pythonguis.com/faq/qtimer-expectations/

[](https://www.pythonguis.com/faq/qtimer-expectations/#menu)
  * Python GUIs
...
Mr_S_J_Childerley | 2021-01-14 20:45:35 UTC | #1
...
![time_out_period_for_QTimer_3s|690x469](https://www.pythonguis.com/static/faq/forum/qtimer-expectations/kuh1XiC5kdcVWx0nQAnRPvaf1nL.png)
...
martin | 2021-01-21 10:27:49 UTC | #2
...
Mr_S_J_Childerley | 2021-01-21 21:26:07 UTC | #3
thanks Martin,
Yes the Y axis is time since the last timer fire.
I think in the first instance I'll use the timer to kick-off at thread to do all or some of the tasks currently performed by the timer method, however none of them are particularly heavy weight. Then if that bares no fruit I'll consider moving to a separate process.
Mark As Complete 
For a complete guide to building GUI applications with Python, see our [PyQt6 tutorial](https://www.pythonguis.com/pyqt6-tutorial/). Using another library? We also have a [PyQt5 tutorial](https://www.pythonguis.com/pyqt5-tutorial/), [PySide6 tutorial](https://www.pythonguis.com/pyside6-tutorial/) and [PySide2 tutorial](https://www.pythonguis.com/pyside2-tutorial/).
[![Martin Fitzpatrick](https://www.pythonguis.com/static/theme/images/authors/martin-fitzpatrick.jpg)](https://www.pythonguis.com/authors/martin-fitzpatrick/)
**QTimer expectations** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/qtimer-expectations/Python books) on the subject. 
**QTimer expectations** was published in [faq](https://www.pythonguis.com/faq/) on January 14, 2021 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
  * [](https://www.pythonguis.com/ "Python GUIs")
