# Content from: https://www.pythonguis.com/faq/spyder-ide-gets-stuck/

[](https://www.pythonguis.com/faq/spyder-ide-gets-stuck/#menu)
  * Python GUIs
...
K_Fine | 2020-05-07 14:27:17 UTC | #1
Hi, I am using the Spyder IDE on Linux, and the console gets stuck right away. Clicking the "x" does not stop the window. 
https://www.pythonguis.com/courses/start/creating-your-first-window/
I managed to get around this problem using this site: https://stackoverflow.com/questions/57408620/cant-kill-pyqt-window-after-closing-it-which-requires-me-to-restart-the-kernal
...
**Spyder IDE gets stuck** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/spyder-ide-gets-stuck/Python books) on the subject. 
**Spyder IDE gets stuck** was published in [faq](https://www.pythonguis.com/faq/) on May 07, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
