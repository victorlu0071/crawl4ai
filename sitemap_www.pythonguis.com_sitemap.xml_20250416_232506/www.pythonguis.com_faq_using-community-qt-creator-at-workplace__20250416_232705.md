# Content from: https://www.pythonguis.com/faq/using-community-qt-creator-at-workplace/

[](https://www.pythonguis.com/faq/using-community-qt-creator-at-workplace/#menu)
  * Python GUIs
...
If you're using PyQt5 (GPL version) the GPL requires you to make the source code available to the users of your application. But _only_ with them, and only on request. It doesn't require you to distribute the application to anyone you don't want to.
...
**Using community qt creator at workplace** was written by [Martin Fitzpatrick](https://www.pythonguis.com/authors/martin-fitzpatrick/) . 
Martin Fitzpatrick has been developing Python/Qt apps for 8 years. Building desktop applications to make data-analysis tools more user-friendly, Python was the obvious choice. Starting with Tk, later moving to wxWidgets and finally adopting PyQt. Martin founded PythonGUIs to provide easy to follow GUI programming tutorials to the Python community. He has written a number of popular [https://www.martinfitzpatrick.com/browse/books/](https://www.pythonguis.com/faq/using-community-qt-creator-at-workplace/Python books) on the subject. 
**Using community qt creator at workplace** was published in [faq](https://www.pythonguis.com/faq/) on October 13, 2020 (updated September 17, 2024) . Feedback & Corrections [can be submitted here](https://tally.so/r/wbvxNE). 
